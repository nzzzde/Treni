        ...
        try:
            ...
            try:
                if (0.3 <= height <= 3):        # Checking the correctnessof variables
                    ...
                    raise ValueError(f"{height}м не є реалістичним ростом людини")
            except ValueError as er_ror:
                print(f"{er_ror}\nСпробуйте ще раз.\n")
...
def training_sets(bmi_value, frequency):
    if bmi_value < 18.5:
        ...
        if set == 1:
            ...
            sets = [
                "Cет №1\nБіг на місці — 5 хвилин\nПрисідання — 20 разів\nЯгодичний міст — 20 разів\nПідняття ніг — 20 разів на кожну ногу\nСупермен — 1 хвилина\nСкручування — 20 разів\nВелосипед — 1 хвилина\nВіджимання — 10 разів\nПланка з ліктів — 30 секунд\nВипади — 20 разів\nВипади в сторону — 20 разів\n",
                "Cет №2\nБіг на місці — 5 хвилин\nСтрибки з розведенням рук і ніг — 10 разів\nЯгодичний міст — 20 разів\nПідняття ніг — 20 разів на кожну ногу\nСупермен — 1 хвилина\nПланка — 30 секунд\nВипади — 20 разів\nВипади в сторону — 20 разів\n",
...
def set_reminder(selected_days):  
    ...
    for day in selected_days:
        while True:
            try:
                reminder_time = input(f"Введіть час для нагадування на {day} у форматі HH:MM (24-годинний формат): ")
        ...
        if choice == '1':
            ...
            try:
                ...
                if 0 <= reminder_to_edit < len(reminders):
                    new_time = input(f"Введіть новий час для нагадування на {reminders[reminder_to_edit][0]} у форматі HH:MM (24-годинний формат): ")
